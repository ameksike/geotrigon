...
Ext.ux.grid.RowEditor = Ext.extend(Ext.Panel, {
    ...
    saveText: 'Guardar',
    cancelText: 'Cancelar',
    commitChangesText: 'Se necesita cancelar o enviar los cambios',
    errorText: 'Error',
    ...
    startEditing: function(rowIndex, doFocus){
	    ...
	    for(var i=0; i<this.disableToEdit.length; i++){
		var cnt = g.view.cm.config[this.disableToEdit[i]];
		if(cnt && cnt.editor && this.activedisable)
		   cnt.editor.disable();
	    }
            this.record = record;
